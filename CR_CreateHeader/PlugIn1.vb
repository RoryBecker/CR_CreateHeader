...
#End Region
    ...
    Private Sub actCreateHeader_Execute(ByVal ea As DevExpress.CodeRush.Core.ExecuteEventArgs) Handles actCreateHeader.Execute
        ' Get Params
        ...
        ' Create Template
        Call CreateTemplateAtSourcepoint(FullTemplateNameAndPath, InsertPoint)
        ' Collect Marker
    ...
    End Function
    Private Sub CreateTemplateAtSourcepoint(ByVal FullTemplateNameAndPath As String, ByVal InsertPoint As SourcePoint)
